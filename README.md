...
| Water slider | Sets the level in the drum, from empty to brim full. Touching it switches to MANUAL; in AUTO it reads out the level the program is at |
...
| 물 슬라이더 | 드럼의 물 높이를 비움부터 가득까지 정합니다. 만지면 수동으로 바뀌고, 자동에서는 코스의 현재 수위를 보여 줍니다 |
