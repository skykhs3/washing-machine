export const STRINGS = {
  en: {
    ...
    resume: 'Resume',
    rpm: 'RPM',
    rpmHint: 'Motor speed. Touching it switches to MANUAL. The mark moves with the water: past it the water is flung into a ring against the wall with a hole down the middle.',
    reverse: 'Reverse',
    water: 'Water',
    waterHint: 'Water level in the drum, from empty to full. Setting it switches to MANUAL. The mark is the level the program itself fills to; past it is more water than a real drum holds.',
    foam: 'Foam',
    foamHint: 'Detergent dose. Sets how much foam the wash and MANUAL make, from none to a drum full of suds. The mark is the dose that gives a concentration of one; past it is over-dosing.',
    prev: 'Prev',
  ...
  ko: {
    ...
    resume: '재생',
    rpm: 'RPM',
    rpmHint: '모터 속도입니다. 만지면 수동으로 바뀝니다. 눈금은 물 양에 따라 움직이며, 그 위에서는 물이 벽으로 던져져 가운데가 뚫린 고리가 됩니다.',
    reverse: '역회전',
    water: '물',
    waterHint: '드럼의 물 높이입니다. 비움부터 가득까지 조절하며, 만지면 수동으로 바뀝니다. 눈금은 코스가 채우는 수위이고, 그 위는 실제 드럼이 담지 않는 양입니다.',
    foam: '거품',
    foamHint: '세제량. 세탁 단계와 수동 모드의 거품 양을 정합니다. 최대로 올리면 드럼이 거품으로 가득 찹니다. 눈금은 농도가 1이 되는 세제량이고, 그 위는 과다 투입입니다.',
    prev: '이전 단계',
